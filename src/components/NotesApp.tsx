...
const defaultNotes : Note[] = [
    {
        id : 1,
        title : "Grocery Items",
        content : "Egg, Milk and Bread"
    },
    {
        id : 2,
        title : "Workout Log",
        content : "Exercises, sets, reps, and progression."
    },
    {
        id : 3,
        title : "Medical History",
        content : "Symptoms, appointments, and treatments."
    }
]
...
const NotesApp = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-background text-foreground">
      <header className="bg-muted shadow p-4">
      ...
      <main className="flex-1 overflow-auto p-4">
        <div className="mb-4">
            ...
            className="w-full p-2 rounded-xl border border-input bg-background text-foreground focus:outline-none focus:ring-1 focus:ring-primary"
            />
            ...
            className="mt-2 w-full p-2 rounded-xl border border-input bg-background text-foreground focus:outline-none focus:ring-1 focus:ring-primary"
            rows={4}
            />
